...
class Run:
    ...
    def grab(self):
        ...
        self.arm.go_to(5, math.radians(-15))
    ...
    def second_floor(self):
        ...
        self.arm.go_to(3, math.radians(100))
        self.arm.go_to(2, math.radians(-45))
        self.time.sleep(1)
        self.arm.go_to(2, math.radians(-65))
        self.time.sleep(1)
        self.arm.go_to(3, math.radians(110))
        ...
        self.arm.go_to(3, math.radians(0))
        self.arm.go_to(2, math.radians(0))
        self.arm.go_to(5, math.radians(0))
        self.time.sleep(2)
    ...
    def first_floor(self):
        ...
        self.arm.go_to(1, math.radians(90))
        # self.time.sleep(1)
        # self.arm.go_to(3, math.radians(30))
        self.time.sleep(1)
        self.arm.go_to(2, math.radians(90))
        self.time.sleep(1)
        self.arm.go_to(3, math.radians(-60))
        self.time.sleep(1)
        self.arm.go_to(4, math.radians(90))
        # self.time.sleep(1)
        # self.arm.go_to(1, math.radians(95))
        # self.arm.go_to(5, math.radians(5))
